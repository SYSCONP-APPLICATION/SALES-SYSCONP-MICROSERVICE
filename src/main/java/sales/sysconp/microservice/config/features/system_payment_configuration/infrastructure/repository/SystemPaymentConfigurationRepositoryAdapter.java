package sales.sysconp.microservice.config.features.system_payment_configuration.infrastructure.repository;
...
import sales.sysconp.microservice.features.system_payment_configuration.infrastructure.repository.JPASystemPaymentConfigurationRepository;
...
public class SystemPaymentConfigurationRepositoryAdapter implements SystemPaymentConfigurationRepositoryOutPort {
    private final sales.sysconp.microservice.features.system_payment_configuration.infrastructure.repository.JPASystemPaymentConfigurationRepository jpaRepository;
