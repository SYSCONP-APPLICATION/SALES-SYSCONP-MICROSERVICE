package sales.sysconp.microservice.config.features.client.infrastructure.repository;
...
import sales.sysconp.microservice.features.client.infrastructure.repository.JPAClientRepository;
...
public class ClientRepositoryAdapter implements ClientRepositoryOutPort {
    private final sales.sysconp.microservice.features.client.infrastructure.repository.JPAClientRepository jpaRepository;
