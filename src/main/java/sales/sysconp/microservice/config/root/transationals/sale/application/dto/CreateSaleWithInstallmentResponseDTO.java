package sales.sysconp.microservice.config.root.transationals.sale.application.dto;
...
public class CreateSaleWithInstallmentResponseDTO {
    ...
    public CreateSaleWithInstallmentResponseDTO() {
    }

    public CreateSaleWithInstallmentResponseDTO(Integer numInstallments, LocalDateTime lastInstallmentDate, InstallmentTypeEnum installmentType, MonthEnum month, Integer year) {
