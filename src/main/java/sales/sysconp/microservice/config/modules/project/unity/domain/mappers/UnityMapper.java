package sales.sysconp.microservice.config.modules.project.unity.domain.mappers;
...
@Mapper(componentModel = "spring", uses = { CompartmentMapper.class, ProjectMapper.class })
